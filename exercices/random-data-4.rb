...
hotels_names = [
  ...
  'Brown Group',
  'Dare LLC',
  'VonRueden, Baumbach and Blick',
  'Murray LLC',
  'Pfeffer, Macejkovic and Batz',
  'Schmitt-Reichert',
  'Koelpin-Feeney',
  'Hyatt Inc',
  'Ondricka, Smith and Rutherford',
  'Cremin Inc',
  'Kling, Luettgen and Jast',
  'Lindgren, Willms and MacGyver',
  'Leffler-Huel',
  'Kulas LLC',
  ...
  'Medhurst-Trantow',
  'Ledner LLC',
  'Purdy, Weimann and Carroll',
  'Johnson, Watsica and Koch',
  'Mohr, Cartwright and Hoppe',
  'Breitenberg Group',
  'Heaney Inc',
  'Heidenreich-Hagenes',
  ...
  'Feest-Bode',
  'Quigley-Braun',
  'Sipes, Schamberger and Stokes',
  'Fritsch, Hegmann and Mueller',
  'Kutch, Ryan and Boyer',
  'Hane, Walker and Kirlin',
  'Schmeler-Renner',
  ...
  'Bosco-Bayer',
  'Reilly-Ebert',
  'Pagac, Simonis and Cole',
  'Murazik, Hauck and Hodkiewicz',
  'Feil LLC',
  'Leffler-Aufderhar',
  "Cummings, O'Hara and Casper",
  'Bruen-Jaskolski',
  'Murphy, Swift and Feest',
  'Medhurst, Streich and Schamberger',
  'Bahringer LLC',
  'Kunze Inc',
  'Deckow-Kihn',
  'Becker, Considine and Koelpin',
  'Nienow LLC',
  'Skiles Group',
  'Sporer Group',
  'Gottlieb, Wolff and Bechtelar',
  'Koelpin, Hoppe and Corwin',
  'Altenwerth and Sons',
  'Aufderhar, Mosciski and Smith',
  'Heaney - Robel and Witting',
  'Herman, Considine and Senger',
  'Schaden LLC',
  'Braun-Wunsch',
  'Schinner, Sauer and Powlowski',
  'Lockman-Wintheiser',
  'Feest, Sporer and Bosco',
  'Ward-Heller',
  'Schiller Group',
  'Champlin-Kemmer',
  'White-Stroman',
  'Hodkiewicz, Luettgen and Stoltenberg',
  'McCullough, Leannon and Nolan',
  'Hintz Group',
  'Goldner LLC',
  'Hegmann Inc',
  'Franecki Group',
  'Ernser, Champlin and Halvorson',
  'Willms, Larson and Herzog',
  'Grant-Hand',
  'Hayes, Koelpin and Smitham',
...
def generate_hotel_dish_codes
  hotels_codes.each do |hotel_code|
    ...
    produced_dishes.each { |dish_code| puts "#{hotel_code};#{dish_code};#{dishes[dish_code]}" }
  end
end
...
def generate_dish_ingredient_codes
  dishes_codes.each do |dish_code|
    ...
    used_ingredients.each { |ingredient| puts "#{dish_code};#{ingredient}" }
  end
end
